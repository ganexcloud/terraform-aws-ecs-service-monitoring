...
#export WEBHOOK_URL="https://hooks.slack.com/services/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"
#export MESSENGER="slack"
#python-lambda-local -f lambda_handler app.py test/eventbridge_event.json
#
#export WEBHOOK_URL="https://discord.com/api/webhooks/973389487885385788/r00XwyacHhGuyjGQHNj1pDJf9ITbFDzmjXaVYyhZgU783JGS35hROT74-c9g9I4T3gkg"
#export MESSENGER="discord"
#python-lambda-local -f lambda_handler app.py test/eventbridge_event.json
#
#export WEBHOOK_URL="https://api.squadcast.com/v2/incidents/api/fb787812c79468065969913aa22938b937e4daf2"
#export MESSENGER="squadcast"
#python-lambda-local -f lambda_handler app.py test/sns-codepipeline-event-pipeline-started.json
